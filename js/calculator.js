...
function damateba8(){
 ...
 function damatebagamravleba(){
    let a = document.getElementById('butgamravleba').innerHTML;
    let b = document.getElementById('pasuxi').innerHTML;
    b += a; // b = b+a;
    document.getElementById('pasuxi').innerHTML = b;
 }
 ...
 function damatebaac(){
    let a = document.getElementById('butac').innerHTML;
    let b = document.getElementById('pasuxi').innerHTML;
